...
carro.adicionarPessoas = function( num ) {
    ...
    var quantasAindaCabem = carro.assentos - carro.quantidadePessoas;
    var pluralSingular = quantasAindaCabem === 1 ? ' pessoa' : ' pessoas';
    ...
    if( totalPessoas > carro.assentos ) {
        return 'Só cabem mais ' + quantasAindaCabem + pluralSingular;
    }
